#ifndef MAINWINDOW_WIDGET_ROBOT_HANDLING_H
#define MAINWINDOW_WIDGET_ROBOT_HANDLING_H
...
#include <thread>
#include "qnode.hpp"
#include "ui_define.hpp" // SW_MODE_HANYANG_ENG 등 정의를 위해 추가
#include "rclcpp/rclcpp.hpp"
#include "rclcpp/clock.hpp"
#include "task_parameter.hpp"
#include "task_planner_default.hpp"
#include "task_planner_hanyang_eng.hpp" // TaskPlannerHanyangEng 클래스 정의를 위해 추가
...
QT_BEGIN_NAMESPACE
namespace Ui { class MainWindow_widgetsRobotHandling; }
QT_END_NAMESPACE

// const double pi = 3.14159265358979;

class MainWindow_widgetsRobotHandling : public QMainWindow
{
    Q_OBJECT
...
public:
    MainWindow_widgetsRobotHandling(QNode* qnode, QWidget *parent = 0);
    ~MainWindow_widgetsRobotHandling();
...
private:
    Ui::MainWindow_widgetsRobotHandling *ui;
...
private Q_SLOTS:
    ...
    void onStepUnitComboBoxChanged(int index);
    void onRotationStepUnitComboBoxChanged(int index);
    void onChemicalGripperButtonClicked();
    void pushButtonAutoToolSetupClicked();
    ...
    // JS Position 버튼들
    void pushButtonSetUIJSPositionRightHomeClickedCallback();
    void pushButtonSetUIJSPositionLeftHomeClickedCallback();
...
// #endif
    ...
    bool doTargetTask(const std::vector<UnitTask> &target_task); // 태스크 실행 함수
...
#endif // MAINWINDOW_WIDGET_ROBOT_HANDLING_H
