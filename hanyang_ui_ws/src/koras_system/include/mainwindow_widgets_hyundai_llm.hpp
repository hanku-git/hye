#ifndef MAINWINDOW_WIDGETS_HYUNDAI_LLM_H
#define MAINWINDOW_WIDGETS_HYUNDAI_LLM_H
...
QT_BEGIN_NAMESPACE
namespace Ui { class MainWindow_widgetsHyundaiLlm; }
QT_END_NAMESPACE
class MainWindow_node;


class MainWindow_widgetsHyundaiLlm : public QMainWindow
{
    Q_OBJECT
...
public:
    MainWindow_widgetsHyundaiLlm(MainWindow_node * taskWindow, QWidget *parent = 0);
    ~MainWindow_widgetsHyundaiLlm();
...
private:
    Ui::MainWindow_widgetsHyundaiLlm *ui;
    QTimer *timer_;
...
#endif // MAINWINDOW_WIDGETS_HYUNDAI_LLM_H
