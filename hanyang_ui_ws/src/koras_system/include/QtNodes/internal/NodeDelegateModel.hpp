...
public:
    ...
    virtual bool portCaptionVisible(PortType, PortIndex) const { return true; }
    ...
    virtual void setNodeStyle(NodeStyle const &style);

    virtual void setWidgetExpand(bool flag) {}
