#ifndef MAINWINDOW_WIDGETS_KORAS_COOKING_H
#define MAINWINDOW_WIDGETS_KORAS_COOKING_H
...
QT_BEGIN_NAMESPACE
namespace Ui { class MainWindow_widgetsKorasCooking; }
QT_END_NAMESPACE
class MainWindow_node;


class MainWindow_widgetsKorasCooking : public QMainWindow
{
    Q_OBJECT
...
public:
    MainWindow_widgetsKorasCooking(MainWindow_node * taskWindow, QWidget *parent = 0);
    ~MainWindow_widgetsKorasCooking();
...
private:
    Ui::MainWindow_widgetsKorasCooking *ui;
    QTimer *timer_;
...
#endif // MAINWINDOW_WIDGETS_KORAS_COOKING_H
