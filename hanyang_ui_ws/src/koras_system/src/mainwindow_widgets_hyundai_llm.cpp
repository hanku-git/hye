...
#include "ui_mainwindow_widgets_hyundai_llm.h"
#include <QKeyEvent>
#include <QApplication>
MainWindow_widgetsHyundaiLlm::MainWindow_widgetsHyundaiLlm(MainWindow_node * taskWindow, QWidget* parent)
    : _taskWindow(taskWindow)
    , QMainWindow(parent)
    , ui(new Ui::MainWindow_widgetsHyundaiLlm)
    , isRecording(false)
{
    ui->setupUi(this);
    ...
    QObject::connect(_taskWindow->getTaskManager()->_qnode, &QNode::sendLogMessageStr , this, &MainWindow_widgetsHyundaiLlm::sendLogMessageStr);
    ...
    connect(ui->pushButton_exit_program, &QPushButton::clicked, this,
            &MainWindow_widgetsHyundaiLlm::testBtnCallback);


    status_update_timer_ = new QTimer(this);
    connect(status_update_timer_, &QTimer::timeout, this, &MainWindow_widgetsHyundaiLlm::statusTimerCallback);
    ...
    connect(ui->pushButton_recording, &QPushButton::pressed, this, &MainWindow_widgetsHyundaiLlm::RecordingStartCallback);
    connect(ui->pushButton_recording, &QPushButton::released, this, &MainWindow_widgetsHyundaiLlm::RecordingStopCallback);
    ...
    //         &MainWindow_widgetsHyundaiLlm::RecordingCallback);

    connect(ui->pushButton_home, &QPushButton::clicked, this,
            std::bind(&MainWindow_widgetsHyundaiLlm::SetPoseCallback, this, "home"));
    connect(ui->pushButton_gr_home, &QPushButton::clicked, this,
            std::bind(&MainWindow_widgetsHyundaiLlm::SetPoseCallback, this, "grp"));
    connect(ui->pushButton_mid, &QPushButton::clicked, this,
            std::bind(&MainWindow_widgetsHyundaiLlm::SetPoseCallback, this, "mid"));
    connect(ui->pushButton_scaning_pose, &QPushButton::clicked, this,
            std::bind(&MainWindow_widgetsHyundaiLlm::SetPoseCallback, this, "scan"));

    connect(ui->radioButton_striker, &QRadioButton::clicked, this,
            &MainWindow_widgetsHyundaiLlm::target_obj_Callback);
	...
	connect(ui->pushButton_test1_in, &QPushButton::clicked, this,
            &MainWindow_widgetsHyundaiLlm::GripperAttachCallback);
    connect(ui->pushButton_test1_out, &QPushButton::clicked, this,
            &MainWindow_widgetsHyundaiLlm::GripperDetachCallback);
    ...
    //          &MainWindow_widgetsHyundaiLlm::BoxSelectionCallback);
    connect(ui->pushButton_blue, &QPushButton::clicked, this,
             &MainWindow_widgetsHyundaiLlm::BoxSelectionCallback);
    connect(ui->pushButton_yellow, &QPushButton::clicked, this,
             &MainWindow_widgetsHyundaiLlm::BoxSelectionCallback);

    connect(_taskWindow->getTaskManager()->_qnode, &QNode::UpdateLLMText, this, &MainWindow_widgetsHyundaiLlm::UpdateLLMText);
    connect(_taskWindow->getTaskManager()->_qnode, &QNode::UpdateVelocites, this, &MainWindow_widgetsHyundaiLlm::UpdateVelocites);
    connect(_taskWindow->getTaskManager()->_qnode, &QNode::UpdateImage, this, &MainWindow_widgetsHyundaiLlm::UpdateImage);
    connect(_taskWindow->getTaskManager()->_qnode, &QNode::UpdateWaypoints, this, &MainWindow_widgetsHyundaiLlm::UpdateWaypoints);
    connect(_taskWindow->getTaskManager()->_qnode, &QNode::UpdateGoalPose, this, &MainWindow_widgetsHyundaiLlm::UpdateGoalPose);
    connect(_taskWindow->getTaskManager()->_qnode, &QNode::LLMNodeReady, this, &MainWindow_widgetsHyundaiLlm::LLMNodeReadyCallback);


    timer_ = new QTimer(this);
    connect(timer_, &QTimer::timeout, this, &MainWindow_widgetsHyundaiLlm::timerCallback);
    timer_->start(100);
}



MainWindow_widgetsHyundaiLlm::~MainWindow_widgetsHyundaiLlm()
{
    delete ui;
    rclcpp::shutdown();
}

void MainWindow_widgetsHyundaiLlm::closeEvent(QCloseEvent *bar)
{
    bar->ignore();
    return;
}

void MainWindow_widgetsHyundaiLlm::sendLogMessageStr(std::string &str) {
...
void MainWindow_widgetsHyundaiLlm::timerCallback() {
...
void MainWindow_widgetsHyundaiLlm::statusTimerCallback() {
...
void MainWindow_widgetsHyundaiLlm::testBtnCallback() {
...
void MainWindow_widgetsHyundaiLlm::keyPressEvent(QKeyEvent *event) {
...
void MainWindow_widgetsHyundaiLlm::keyReleaseEvent(QKeyEvent *event) {
    // if (event->key() == Qt::Key_Space && isRecording && _taskWindow->getTaskManager()->_qnode->is_llm_task_fin) {
    //     isRecording = false;
...
void MainWindow_widgetsHyundaiLlm::SetPoseCallback(const std::string& position) {
    double qd = 30;
    double qdd = 60;
...
void MainWindow_widgetsHyundaiLlm::llm_node_Callback(LLM_PARAM &llm_param) {
    try {
...
void MainWindow_widgetsHyundaiLlm::target_obj_Callback() {
    int new_gripper = 1;
    int new_tip = 1;
...
void MainWindow_widgetsHyundaiLlm::GraspingTargetObject() {
...
void MainWindow_widgetsHyundaiLlm::GripperAttachCallback() {
...
void MainWindow_widgetsHyundaiLlm::GripperDetachCallback() {
    QPushButton* button = qobject_cast<QPushButton*>(sender());
    int gripper_type = 0; // 기본값
    int tip_type = 0;
...
void MainWindow_widgetsHyundaiLlm::BoxSelectionCallback() {
    QPushButton* button = qobject_cast<QPushButton*>(sender());
    int boxNumber = 1; // 기본값
    int palette_num = 5;
...
void MainWindow_widgetsHyundaiLlm::UpdateImage(const QImage &image, const QString &current_pass) {
    if (current_pass == "A") {
...
void MainWindow_widgetsHyundaiLlm::UpdateWaypoints(const QString &coordinates,  const QString &current_pass) {
...
void MainWindow_widgetsHyundaiLlm::UpdateLLMText(const QString &target, const QString &goal, const QString &passes) {
...
void MainWindow_widgetsHyundaiLlm::UpdateVelocites(const QString &velocities) {
...
void MainWindow_widgetsHyundaiLlm::UpdateGoalPose(const geometry_msgs::msg::Pose2D &goal_pose) {
...
void MainWindow_widgetsHyundaiLlm::TargetObjectParamSetting() {
