    ...
    , _orientation(Qt::Horizontal)
{
    ...
    connect(this, &BasicGraphicsScene::nodeDoubleClicked, this, &BasicGraphicsScene::onNodeDoubleClicked);
...
void BasicGraphicsScene::onNodeDoubleClicked(NodeId const nodeId)
{
}
