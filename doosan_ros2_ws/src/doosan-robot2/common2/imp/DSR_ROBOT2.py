...
def task_compliance_ctrl(stx=[3000, 3000, 3000, 200, 200, 200], time=0):      ###3000 , 3000, 3000, 200, 200, 200
    # st
...
def set_stiffnessx(stx=[400, 400, 400, 100, 100, 100], time=0):
    # st
    if type(stx) != list or len(stx) != 6:
        raise DR_Error(DR_ERROR_TYPE, "Invalid type : stx")
...
##### force/stiffness Control #########################################################################################################################
    ...
    def set_stiffnessx(self, stx=[400, 400, 400, 100, 100, 100], time=0):
        # st
        if type(stx) != list or len(stx) != 6:
            raise DR_Error(DR_ERROR_TYPE, "Invalid type : stx")
...
##### TCP/TOOL #########################################################################################################################
    ...
    def add_tool(self, name, weight, cog, inertia):
        if type(name) != str:
            raise DR_Error(DR_ERROR_TYPE, "Invalid type : name")
        if len(cog) != 3:
            raise DR_Error(DR_ERROR_VALUE, "Invalid cog length: expected 3 elements")
        if len(inertia) != 6:
            raise DR_Error(DR_ERROR_VALUE, "Invalid inertia length: expected 6 elements")
