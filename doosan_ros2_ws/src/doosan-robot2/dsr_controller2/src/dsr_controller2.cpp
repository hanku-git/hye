...
{   
    ...
    RCLCPP_INFO(rclcpp::get_logger("dsr_controller2"),"THIS %p", Drfl);
    res->success = false;
    ...
    if(req->sync_type == 0){
        ...
        RCLCPP_INFO(rclcpp::get_logger("dsr_controller2"),"SYNC_TYPE: 0");
        ...
        RCLCPP_INFO(rclcpp::get_logger("dsr_controller2"),"SYNC_TYPE: 1");
